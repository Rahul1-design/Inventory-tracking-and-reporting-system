...
const mockSettings: UserSetting[] = [
    { label: "Username", value: "rahul_shrestha", type: "text" },
    { label: "Email", value: "rahulshrestha337@gmail.com", type: "text" },
                        ...
                        {userSettings.map((setting, index) => (
                            <tr className="hover:bg-blue-50" key={setting.label} >
                                ...
                                <td className="py-2 px-4">{setting.type === "toggle" ? (
                                    ...
                                    <input type="text" className="px-4 py-2 border rounded-lg text-gray-500 focus:outline- focus:border-blue-500" value={setting.value as string} onChange={(e) => { const settingsCopy = [...userSettings]; 
